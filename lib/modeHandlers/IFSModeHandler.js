...
class IFSModeHandler extends BaseModeHandler {
  ...
  _getPhaseGuidance() {
    ...
    const guidance = {
      ...
      fleshOut: `Getting to know "${partName}" — stay curious about HOW it shows up (its age, tone, how long it's been around, what it's like to be near it). You can begin to sense its role, but do NOT yet ask what it protects them from or what it fears — those come later. First help them genuinely turn toward it. Exchanges in phase: ${exchangesInPhase}.`,
