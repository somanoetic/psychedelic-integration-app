-- ============================================================================
-- CONTEXT SYSTEM MIGRATION (SAFE - HANDLES EXISTING TABLES)
-- ============================================================================
-- This migration safely creates or alters tables to match the context system
-- If tables exist, it will add missing columns without losing data
-- ============================================================================
...
-- Drop existing table (ONLY if you want to start fresh - WILL DELETE DATA!)
-- Uncomment this line if you want to delete existing data and start over:
-- DROP TABLE IF EXISTS ifs_parts_inventory CASCADE;
